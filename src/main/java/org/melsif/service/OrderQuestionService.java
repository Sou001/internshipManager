...
public class OrderQuestionService {
    public List<OrderQuestion> getAllOrderQuestions() {
        return OrderQuestionDao.getInstance().findAll();
    }
    
    public void newOrderQuestion(OrderQuestion orderQuestion) {
        OrderQuestionDao.getInstance().persist(orderQuestion);
    }
}
